...
export const translations = {
    ja: {
        ...
        features_sweets: "スイーツ",
        features_lunch: "ランチ",
        features_kidsfriendly: "キッズ歓迎",
        features_safe: "治安が良い",
        features_free: "無料",
        features_alcohol: "アルコール",
        features_refillcoffee: "おかわり珈琲",
        features_smoking: "喫煙可",
        features_nosmoking: "禁煙",
        features_parking: "駐車場あり",
        features_coworking: "コワーキング",
        features_sofa: "ソファ席",
        features_hideaway: "隠れ家",
    },
    en: {
        ...
        features_sweets: "Sweets",
        features_lunch: "Lunch",
        features_kidsfriendly: "Kids Friendly",
        features_safe: "Safe",
        features_free: "Free",
        features_alcohol: "Alcohol",
        features_refillcoffee: "Refill Coffee",
        features_smoking: "Smoking",
        features_nosmoking: "No Smoking",
        features_parking: "Parking",
        features_coworking: "Coworking",
        features_sofa: "Sofa",
        features_hideaway: "Hideaway",
    },
};
